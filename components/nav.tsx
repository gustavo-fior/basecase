      ...
      <nav className="w-full sticky top-0 z-50">
        <div className="flex justify-end sm:justify-between items-center px-4 max-w-5xl mx-auto py-4 sm:py-6">
          <div className="hidden md:flex space-x-2 items-center">
            <div className={`px-1.5 py-1.5 rounded bg-gray-100 dark:bg-gray-800 sm:px-2 sm:py-2 ${
              isScrolled ? 'backdrop-blur-sm bg-gray-100/30 dark:bg-gray-800/30' : ''
            }`}>
              <svg width="24" height="20" viewBox="0 0 596 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-[var(--color-primary)]">
                <g>
