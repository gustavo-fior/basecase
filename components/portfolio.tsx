        ...
        {portfolio.map((client, index) => (
          ...
          >
            <div className="p-8 rounded relative flex items-center justify-center">
              <div className="absolute top-0 left-0 text-gray-800 group-hover:text-[#CE4B01]">
                +
              </div>
              <div className="absolute top-0 right-0 text-gray-800 group-hover:text-[#CE4B01]">
                +
              </div>
              <div className="absolute bottom-0 left-0 text-gray-800 group-hover:text-[#CE4B01]">
                +
              </div>
              <div className="absolute bottom-0 right-0 text-gray-800 group-hover:text-[#CE4B01]">
                +
              </div>
              ...
              <div className="absolute inset-0 p-4 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center text-center">
                ...
                {typeof client.description === "object" && (
                  <span className="text-[#CE4B01] text-xs mt-1 font-inter">
