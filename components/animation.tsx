...
const AsciiAnimation = () => {
  ...
  return (
    <div className="hidden md:block h-[225px] border border-dashed border-[var(--color-primary)] flex justify-center mb-10">
      <pre className="font-mono text-center whitespace-pre text-[var(--color-primary)] p-4 w-full pt-[45px]">
