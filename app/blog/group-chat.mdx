...
replaced my contact list with ai replicas of people who inspire me. the result is a system that
feels strikingly realistic and fun.
...
finally, engineering the group chat itself was only half of the fun. in a separate post, i’ll dive
into the details of the imessage interface - from the scrolling gradient to the message tails to the
sound effects. in the meantime, try it out for yourself and spin up your own conversations with
people who inspire you. it’s quite fun (and sometimes hilarious) to partake in the conversation or
