...
should also give a shout out to [windsutf](https://codeium.com/windsurf) for helping me write a lot
of this code.
...
finally, building this backend was only half of the fun. in a separate post, i’ll dive
into the wizardry involved in building the frontend to look and feel exactly like imessage. in the meantime, try it out for yourself and spin
up your own conversations with people who inspire you. it’s quite fun (and sometimes hilarious) to
partake in the conversation or sit back and watch the chaos unfold!
