...
- **building ios-grade experiences for the web**  
  ...
  another layer of complexity. i’d often get a feature working great on desktop, then test on mobile
...
- **wrestling with svgs**  
  ...
  has close to a hundred svgs of different variations. using them wasn’t so much hard as it was a
...
- **animations & the art of articulation**  
  ...
  them to codegen tools like windsurf, chatgpt, or claude (or friends like
  [eden](https://x.com/eden_halperin) and [john](https://x.com/JohnPhamous)). the mention animation,
  for example, was very hard to describe in words. i spend a good hour just playing around with
  imessage and studying what was actually happening before i could properly describe it. with all
  the progress that has been made in codegen tools to get to the point where "if you can speak it,
  you can build it", actually being able to articulate exactly what you want is an important skill.
